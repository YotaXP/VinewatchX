...
namespace VinewatchX.Rights
{
    ...
    public static class UAC
    {
        ...
        public static Label lbIsRunAsAdmin = new Label();
        public static Label lbIsElevated = new Label();
        public static Label lbInAdminGroup = new Label();
        public static Label lbIntegrityLevel = new Label();
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                lbInAdminGroup.Text = fInAdminGroup.ToString();
            }
            catch (Exception ex)
            {
                lbInAdminGroup.Text = "N/A";
            ...
            try
            {
                ...
                lbIsRunAsAdmin.Text = fIsRunAsAdmin.ToString();
            }
            catch (Exception ex)
            {
                lbIsRunAsAdmin.Text = "N/A";
            ...
            if (Environment.OSVersion.Version.Major >= 6)
            {
                ...
                try
                {
                    ...
                    lbIsElevated.Text = fIsElevated.ToString();
                ...
                try
                {
                    ...
                    switch (IL)
                    {
                        case NativeMethods.SECURITY_MANDATORY_UNTRUSTED_RID:
                            lbIntegrityLevel.Text = "Untrusted"; break;
                        case NativeMethods.SECURITY_MANDATORY_LOW_RID:
                            lbIntegrityLevel.Text = "Low"; break;
                        case NativeMethods.SECURITY_MANDATORY_MEDIUM_RID:
                            lbIntegrityLevel.Text = "Medium"; break;
                        case NativeMethods.SECURITY_MANDATORY_HIGH_RID:
                            lbIntegrityLevel.Text = "High"; break;
                        case NativeMethods.SECURITY_MANDATORY_SYSTEM_RID:
                            lbIntegrityLevel.Text = "System"; break;
                        default:
                            lbIntegrityLevel.Text = "Unknown"; break;
                    }
                }
                catch (Exception ex)
                {
                    lbIntegrityLevel.Text = "N/A";
        ...
        public static bool ExecuteElevated()
        {
            return ExecuteElevated(null);
        }

        public static bool ExecuteElevated(string Filename)
        {
            if (!IsStarted)
                Start();
            ...
            // Elevate the process if it is not run as administrator.
                ...
                try
                {
                    ...
                    if (VinewatchX.Forms.MainForm.mf != null)
                    {
